...
def infer_atomic_recovery_task_name(
    ...
    exact_prompt_matches = {
        ...
        "open the drawer.": "OpenDrawer",
        "close drawer.": "CloseDrawer",
        "close the drawer.": "CloseDrawer",
        "open cabinet.": "OpenCabinet",
        "open the cabinet.": "OpenCabinet",
        "close cabinet.": "CloseCabinet",
        "close the cabinet.": "CloseCabinet",
        "open fridge.": "OpenFridge",
        "open the fridge.": "OpenFridge",
        "close fridge.": "CloseFridge",
        "close the fridge.": "CloseFridge",
        "open microwave.": "OpenMicrowave",
        "open the microwave.": "OpenMicrowave",
        "close microwave.": "CloseMicrowave",
        "close the microwave.": "CloseMicrowave",
        "open dishwasher.": "OpenDishwasher",
        "open the dishwasher.": "OpenDishwasher",
        "close dishwasher.": "CloseDishwasher",
        "close the dishwasher.": "CloseDishwasher",
        "open toaster oven.": "OpenToasterOvenDoor",
        "open the toaster oven.": "OpenToasterOvenDoor",
        "open the toaster oven door.": "OpenToasterOvenDoor",
        "close toaster oven.": "CloseToasterOvenDoor",
        "close the toaster oven.": "CloseToasterOvenDoor",
        "close the toaster oven door.": "CloseToasterOvenDoor",
        "turn on water.": "TurnOnSinkFaucet",
        "turn on the water.": "TurnOnSinkFaucet",
        "turn on the sink faucet.": "TurnOnSinkFaucet",
        "turn off water.": "TurnOffSinkFaucet",
        "turn off the water.": "TurnOffSinkFaucet",
        "turn off the sink faucet.": "TurnOffSinkFaucet",
        "turn on burner.": "TurnOnStove",
        "turn on the burner.": "TurnOnStove",
        "turn on the stove.": "TurnOnStove",
        "turn off burner.": "TurnOffStove",
        "turn off the burner.": "TurnOffStove",
        "turn off the stove.": "TurnOffStove",
        "start microwave.": "TurnOnMicrowave",
        "start the microwave.": "TurnOnMicrowave",
        "turn on the microwave.": "TurnOnMicrowave",
        "start coffee machine.": "StartCoffeeMachine",
        "start the coffee machine.": "StartCoffeeMachine",
        "start toaster.": "TurnOnToaster",
        "start the toaster.": "TurnOnToaster",
        "turn on the toaster.": "TurnOnToaster",
        "open freezer.": "OpenFridge",
        "open the freezer.": "OpenFridge",
    }
